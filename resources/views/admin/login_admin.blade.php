                ...
                <div class="row">
                    <div class="col-md-6">
                        <img style="max-width:105%; height: auto;" class="card-img-left img-fluid"
                            src="{{ asset('assets/images/auth-bg-4.jpg') }}" alt="">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <h4 class="text-muted text-center font-size-18 mt-3"><b>Masuk Admin</b></h4>
                            <div class="p-3">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('proses.login.admin') }}">
                                    @csrf
