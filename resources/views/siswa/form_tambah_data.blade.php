                                ...
                                @else
                                    @if ($data_siswa->foto == null)
                                        <img src={{ asset('assets/images/users/default_profileXz.png') }} alt=""
                                            class="avatar-xl">
                                    @else
                                        <img src={{ asset('assets/images/users/') . '/' . $data_siswa->foto }}
                                            alt="" class="avatar-xl">
                                    @endif
                                @endif
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-left: 20px;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="email"
                                                ...
                                                class="form-control" type="email" placeholder="Email" id="email"
                                                required>
                                            @error('email')
                                                <small class="text-danger">
                                                    <i class="fa fa-warning"></i>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="nama"
                                                ...
                                                class="form-control" type="text" placeholder="Nama" id="nama"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select value="{{ old('jenis_kelamin') }}" name="jenis_kelamin"
                                                class="form-select" aria-label="Default select example" required>
                                                <option selected="" disabled>Pilih Jenis Kelamin</option>
                                                @if ($data_siswa != null)
                                                    <option value="1"
                                                        {{ $data_siswa->jenis_kelamin == 1 ? 'selected' : '' }}>
                                                        Laki-Laki</option>
                                                    <option value="2"
                                                        {{ $data_siswa->jenis_kelamin == 2 ? 'selected' : '' }}>
                                                        Perempuan</option>
                                                @else
                                                    <option value="1"
                                    ...
                                    {{-- tempat lahir --}}
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Tempat
                                            Lahir</label>
                                        <div class="col-sm-10">
                                            <input name="tempat_lahir"
                                                value="{{ $data_siswa != null ? $data_siswa->tempat_lahir : old('tempat_lahir') }}"
                                                class="form-control" type="text" placeholder="Tempat Lahir"
                                                id="tempat_lahir">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="tanggal_lahir"
                                                ...
                                                class="form-control" type="date" placeholder="Tanggal Lahir"
                                        ...
                                        <div class="col-sm-10">
                                            <select name="agama" class="form-select"
                                                ...
                                                @foreach ($list_agama as $items => $agama)
                                                    <option value="{{ $items }}"
                                                        {{ $data_siswa != null && $data_siswa->agama == $items ? 'selected' : '' }}>
                                                        {{ $agama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="alamat" class="form-control" placeholder="Alamat" id="alamat" rows="3">{{ $data_siswa != null ? $data_siswa->alamat : old('alamat') }}</textarea>
                                        </div>
                                    </div>

                                    {{-- Status Anak --}}
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Status
                                            Anak</label>
                                        <div class="col-sm-10">
                                            <input name="status_anak"
                                                value="{{ $data_siswa != null ? $data_siswa->status_anak : old('status_anak') }}"
                                                class="form-control" type="text" placeholder="Status Anak"
                                                id="status_anak">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="kontak"
                                                ...
                                                class="form-control" type="numerik" placeholder="Kontak"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="negara"
                                                ...
                                                class="form-control" type="text" placeholder="Negara"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="provinsi"
                                                ...
                                                class="form-control" type="text" placeholder="Provinsi"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    {{-- Kode Pos --}}
                                    <div class="row mb-3">
                                        <label for="example-date-input" class="col-sm-2 col-form-label">Kode
                                            Pos</label>
                                        <div class="col-sm-10">
                                            <input name="kode_pos"
                                                value="{{ $data_siswa != null ? $data_siswa->kode_pos : old('kode_pos') }}"
                                                class="form-control" type="number" placeholder="Kode Pos"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    {{-- No Tlp Rumah --}}
                                    <div class="row mb-3">
                                        <label for="example-date-input" class="col-sm-2 col-form-label">No Telpon
                                            Rumah</label>
                                        <div class="col-sm-10">
                                            <input name="no_tlp_rumah"
                                                value="{{ $data_siswa != null ? $data_siswa->no_tlp_rumah : old('no_tlp_rumah') }}"
                                                class="form-control" type="text" placeholder="No Telpon Rumah"
                                                id="example-date-input">
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-left: 20px;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="nik_ayah"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->nik_ayah : old('nik_ayah') }}"
                                                class="form-control" type="number" placeholder="NIK"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="nama_ayah"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->nama_ayah : old('nama_ayah') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select value="{{ old('pekerjaan_ayah') }}" name="pekerjaan_ayah"
                                    ...
                                    {{-- no telpon ayah --}}
                                    <div class="row mb-3">
                                        <label for="example-date-input" class="col-sm-2 col-form-label">No
                                            Telpon</label>
                                        <div class="col-sm-10">
                                            <input name="n_hp_ayah"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->no_hp_ayah : old('n_hp_ayah') }}"
                                                class="form-control" type="number" placeholder="No Telpon"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Email</label>
                                        <div class="col-sm-10">
                                            <input name="email_ayah"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->email_ayah : old('email_ayah') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select value="{{ old('pendidikan_ayah') }}" name="pendidikan_ayah"
                                                class="form-select" aria-label="Default select example">
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-left: 20px;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="nik_ibu"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->nik_ibu : old('nik_ibu') }}"
                                                class="form-control" type="number" placeholder="NIK"
                                                id="example-text-input">
                                            @error('nik_ibu')
                                                <small class="text-danger">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="nama_ibu"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->nama_ibu : old('nama_ibu') }}"
                                                class="form-control" type="text" placeholder="Nama"
                                                id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Pekerjaan</label>
                                        <div class="col-sm-10">
                                            <select value="{{ old('pekerjaan_ibu') }}" name="pekerjaan_ibu"
                                                class="form-select" aria-label="Default select example">
                                                <option selected="" disabled>Pilih Jenis Pekerjaan</option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="n_hp_ibu"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->no_hp_ibu : old('n_hp_ibu') }}"
                                                class="form-control" type="number" placeholder="No Telpon"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Email</label>
                                        <div class="col-sm-10">
                                            <input name="email_ibu"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->email_ibu : old('email_ibu') }}"
                                                class="form-control" type="email" placeholder="Email"
                                                id="example-text-input">
                                            @error('email_ibu')
                                                <small class="text-danger">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Pendidikan</label>
                                        <div class="col-sm-10">
                                            <select value="{{ old('pendidikan_ibu') }}" name="pendidikan_ibu"
                                                class="form-select" aria-label="Default select example">
                                                <option selected="" disabled>Pilih Jenis Pendidikan</option>
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-left: 20px;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="nik_wali"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->nik_wali : old('nik_wali') }}"
                                                class="form-control" type="number" placeholder="NIK"
                                                id="example-text-input">
                                            @error('nik_wali')
                                                <small class="text-danger">
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Nama</label>
                                        <div class="col-sm-10">
                                            <input name="nama_wali"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->nama_wali : old('nama_wali') }}"
                                                class="form-control" type="text" placeholder="Nama"
                                                id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Pekerjaan</label>
                                        <div class="col-sm-10">
                                            <select value="{{ old('pekerjaan_wali') }}" name="pekerjaan_wali"
                                                class="form-select" aria-label="Default select example">
                                                <option selected="" disabled>Pilih Jenis Pekerjaan</option>
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-date-input" class="col-sm-2 col-form-label">No
                                            Telpon</label>
                                        <div class="col-sm-10">
                                            <input name="n_hp_wali"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->no_hp_wali : old('n_hp_wali') }}"
                                                class="form-control" type="number" placeholder="No Telpon"
                                                id="example-date-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Email</label>
                                        <div class="col-sm-10">
                                            <input name="email_wali"
                                                value="{{ $data_siswa != null ? $data_siswa->WaliSiswa->email_wali : old('email_wali') }}"
                                                class="form-control" type="email" placeholder="Email"
                                                id="example-text-input">
                                            @error('email_wali')
                                                <small class="text-danger">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Pendidikan</label>
                                        <div class="col-sm-10">
                                            <select value="{{ old('pendidikan_wali') }}" name="pendidikan_wali"
                                                class="form-select" aria-label="Default select example">
                                                <option selected="" disabled>Pilih Jenis Pendidikan</option>
