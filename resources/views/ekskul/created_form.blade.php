...
<head>
    @include('partials/title-meta', ['title' => $title . ' Ekskul'])
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-left: 20px;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="kode_ekskul"
                                                value="{{ $get_ekskul != null ? $get_ekskul->kode_ekskul : old('kode_ekskul') }}"
                                                class="form-control" type="text" placeholder="Kode Ekskul"
                                                id="kode_ekskul" @if ($get_ekskul != null) readonly @endif
                                                required>
                                            @error('kode_ekskul')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_ekskul" class="form-control"
                                                value="{{ $get_ekskul != null ? $get_ekskul->nama_ekskul : old('nama_ekskul') }}"
                                                placeholder="Ekskul" required>
                                        </div>
                                    </div>
                                            ...
                                            <select value="{{ old('tahun_ajaran') }}" name="tahun_ajaran"
                                                ...
                                                @foreach ($list_tahun_ajaran as $keys => $tahun_ajaran)
                                                    <option value="{{ $tahun_ajaran->id_tahun_ajaran }}"
                                                        {{ $get_ekskul != null && $tahun_ajaran->id_tahun_ajaran === $get_ekskul->id_tahun_ajaran ? 'selected' : '' }}>
